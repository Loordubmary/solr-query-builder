<?php
	...
	*/
	...
	class MultipleSearch extends CI_Controller {
		...
		*/
		public function multipleSearch() {
			...
			$query->createFilterQuery('product_price')->addTag('product_price')->setQuery('product_price:"0.52" OR product_price:"0.98"');
			...
			$facetField->addExclude('product_price');
